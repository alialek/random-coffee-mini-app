...
import { setAbout, setParticipantInfo, setParticipationStatus } from './../store/data/actions';
class Home extends React.Component {
    ...
    alertParticipationStatus = (enabled) => {
        let title = this.props.participationStatus ? "прекратить" : "продолжить"
        this.props.setPopout(
            <Alert
                actions={[{
                    ...
                    mode: 'destructive',
                    autoclose: true,
                    action: () => this.props.setParticipationStatus(!this.props.participationStatus),
                }, {
                    title: 'Отмена',
                    autoclose: true,
                    mode: 'cancel'
            ...
            >
                <span><Title level="3" weight="bold">Подтвердите действие</Title><br/>Вы уверены, что хотите<br/>{title} участие?</span>
            </Alert>
        )
    };
    ...
    render() {
        const { id, profile, router, participantInfo, participationStatus} = this.props;
                                        ...
                                        <Card>
                                            ...
                                            <Div>
                                                ...
                                                <Button
                                                    ...
                                                    stretched
                                                    size="l"
                                                    onClick={() => this.alertParticipationStatus()}
                                                >
                                                    <div className="d-row align-center">
                                                        {this.props.participationStatus ? "Остановить участие" : "Продолжить участие"}
                                                    </div>
                                                </Button>
                                            </Div>
                                        </Card>
...
const mapStateToProps = (state) => {
    return {
        ...
        participationStatus: state.data.participationStatus,
    };
};
...
function mapDispatchToProps(dispatch) {
    return {
        dispatch,
        ...bindActionCreators({ setAbout, setParticipantInfo, setParticipationStatus, getProfile, setSnackbar }, dispatch),
    };
}
