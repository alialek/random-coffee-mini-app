    ...
    store.getState().data.notifications
        ? api.bridge
              ...
              .then((res) => {
                  ...
                  store.dispatch({ type: 'SET_SNACKBAR', payload: { data: snack('disabled') } });
                  callback();
              })
              .catch((err) => {
                  callback();
        ...
        : api.bridge
              ...
              .then((res) => {
                  store.dispatch({ type: 'SET_SNACKBAR', payload: { data: snack('enabled') } });
                  tapticNotification('success');
              ...
              .catch(() => {
                  ...
                  store.dispatch({ type: 'SET_SNACKBAR', payload: { data: snack('error') } });
                  callback();
              });
};
...
export const setIntroViewed = async () => {
    api.storageSet(STORAGE_KEYS.STATUS, 'ye').finally(() => router.replacePage(PAGE_MAIN));
};
