...
import './intro.css';
import { getProfile, setAbout, setParticipantInfo, setParticipationStatus } from '../store/data/actions';
                                                ...
                                                ? registerUser(this.props.about)
                                                      .then(() => {
                                                          user().then((res) => {
                                                              ...
                                                              this.props.setParticipationStatus(true);
...
function mapDispatchToProps(dispatch) {
    return {
        dispatch,
        ...bindActionCreators({ getProfile, setAbout, setParticipantInfo, setParticipationStatus }, dispatch),
    };
}
